...
def load_spiking_data(
    ...
    ) -> tuple[np.ndarray, np.ndarray, np.ndarray, np.ndarray, np.ndarray, np.ndarray, nap.TsGroup, nap.IntervalSet, np.ndarray, np.ndarray]:
    ...
    Returns:
        ...
        (np.ndarray): List of excitatory neurons.
        (np.ndarray): List of inhibitory neurons.
    """
